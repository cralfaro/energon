...
@WebAppConfiguration
public class RemoveUserAndMessagesControllerTests {
	...
	public void setup() throws Exception {
		...
		userService.saveUser(new User("7", "Griezman"));
		...
		messageService.postMessage(new Message("7", "5", "HIANDRES"));

	}

	@Test
	public void removeUserAndMessages() throws Exception {
        ...
        this.mockMvc.perform(get("/messages/users/5"))
                .andExpect(content().contentType(contentType))
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("$", hasSize(1)))
                .andExpect(jsonPath("$[0].sender", is("Griezman")))
